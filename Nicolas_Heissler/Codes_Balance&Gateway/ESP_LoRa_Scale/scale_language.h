...
#define scale_language_h
 ...
 const char *action_text[12][2] = {"AUCUNE","ACTION","NOURRISS."," 50/50","NOURRISS."," 70/30","NOURRISS.",
 ...
 #define TEMP_ERROR3  "Contrôlez le "
 #define TEMP_ERROR4  "cablâge"
 ...
 #define TEMP_DRIFT2 "dérive en"
 #define TEMP_DRIFT3 "temperature"
